const dataSlider = [
  {
    ...
    technologyStack:
      "React(useState, useEffect, useContext), Ajax(fetch(GET,PUT,POST,DELETE)), CSS(FLEX, GRID, Responsive design)",
    description:
      "Mesto is an interactive page for posting photos with the opportunity to edit a profile, delete your own publication, like and view the pictures.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "Todo list is an application for writing tasks with the opportunity to mark completed, delete and edit labels.",
  },
  {
    id: 4,
    ...
    description:
      "One of my first projects. A ordinary landing page without JavaScript",
  },
  {
    id: 5,
    ...
    technologyStack:
      "React(useState, useEffect, useContext, useHistory, HOC, router), Ajax(fetch(GET,PUT,POST,DELETE)), CSS(FLEX, GRID, Responsive design)",
    description:
      "MESTO application with a modified opportunity to sign up and log in users.",
  },
  {
    id: 6,
